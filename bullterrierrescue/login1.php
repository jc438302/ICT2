<?php
	...
	session_start();
	include_once('../ICT1/ProjectFinalStage/include/config.php');	
...
<link href="../ICT1/ProjectFinalStage/css/login.css" rel="stylesheet" type="text/css">
<link href="../ICT1/ProjectFinalStage/css/styles.css" rel="stylesheet" type="text/css">
<script src="../ICT1/ProjectFinalStage/js/nav.js"></script>
<script src="../ICT1/ProjectFinalStage/js/member.js"></script>
</head>
...
<body onLoad="run_first()">
	...
	<?php include("../ICT1/ProjectFinalStage/include/nav.inc") ?>

<div id="member_frm" class="member_frm">
<h1>Login</h1>
<p>Please enter your email and password</p>
<form action="../ICT1/ProjectFinalStage/login.php" method="post">
    <div class="row">
    	<div class="col">
